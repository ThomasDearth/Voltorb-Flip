...
class LevelsTest {
	...
	public void testLevelValidity() {
		// Level 1
		for (int i = 0; i < 10; i++) {
			int[] tiles = Levels.getInstance().getTiles(1);
		...
		// Level 2
		for (int i = 0; i < 10; i++) {
			int[] tiles = Levels.getInstance().getTiles(2);
			int score = (int) Math.pow(2, tiles[0]) * (int) Math.pow(3, tiles[1]);
		...
		// Level 3
		for (int i = 0; i < 10; i++) {
			int[] tiles = Levels.getInstance().getTiles(3);
			int score = (int) Math.pow(2, tiles[0]) * (int) Math.pow(3, tiles[1]);
		...
		// Level 4
		for (int i = 0; i < 10; i++) {
			int[] tiles = Levels.getInstance().getTiles(4);
			int score = (int) Math.pow(2, tiles[0]) * (int) Math.pow(3, tiles[1]);
		...
		// Level 5
		for (int i = 0; i < 10; i++) {
			int[] tiles = Levels.getInstance().getTiles(5);
			int score = (int) Math.pow(2, tiles[0]) * (int) Math.pow(3, tiles[1]);
		...
		// Level 6
		for (int i = 0; i < 10; i++) {
			int[] tiles = Levels.getInstance().getTiles(6);
			int score = (int) Math.pow(2, tiles[0]) * (int) Math.pow(3, tiles[1]);
		...
		// Level 7
		for (int i = 0; i < 10; i++) {
			int[] tiles = Levels.getInstance().getTiles(7);
			int score = (int) Math.pow(2, tiles[0]) * (int) Math.pow(3, tiles[1]);
		...
		// Level 8
		for (int i = 0; i < 10; i++) {
			int[] tiles = Levels.getInstance().getTiles(8);
			int score = (int) Math.pow(2, tiles[0]) * (int) Math.pow(3, tiles[1]);
